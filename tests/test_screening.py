...
Run:  python tests/test_screening.py
"""
...
from app.models.entities import UserAccount, ScreeningResult
from app.services.screening import ScreeningService, get_scale, score_to_severity
